  ...
  return (
    <HomeTwoContainer>
        <div className='home-two-primary'>
            ...
            <p className='primary-two'>We offer, an unparalleled spectrum of preventive and diagnostic treatment options across specialties such as Kidney Transplant, Liver Transplant, Oncology, Neuro Sciences, Urology, Gastroenterology, Cardiac Sciences, Orthopaedics, Nephrology, Pulmonology, Aesthetic & Reconstructive Surgery, Endocrinology, and Diabetes and has catered to more than 1mn patients.<br/><br/>
            {/* <p className='primary-two'> */}
